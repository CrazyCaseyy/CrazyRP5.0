...
Config.JobLocations = {
    bus = vec3(435.24, -647.33, 27.74),           -- qbx_busjob config/client.lua ped.coords
    taxi = vec3(894.21, -180.4, 73.7),            -- qbx_taxijob config/client.lua ped.coords
    tow = vec3(495.7, -1340.68, 28.31),           -- qbx_towjob config/shared.lua locations.start
