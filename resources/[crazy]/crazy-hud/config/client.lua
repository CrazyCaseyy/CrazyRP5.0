return {
    useMPH = true, -- If true, speed math will be done as MPH, if false KPH will be used

    noHudVehicles = { -- Vehicle model hashes that should never show the vehicle hud (e.g. bicycles, submarines)
    },
