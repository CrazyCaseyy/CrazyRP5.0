...
function GiveVehicleKeys(vehicleEntity, vehicleHash, vehicleModelName, vehiclePlate)
...
--- @param vehicleModelName string
--- @param vehiclePlate string ( non trimmed )
function RemoveVehicleKeys(vehicleEntity, vehicleHash, vehicleModelName, vehiclePlate)
    if IsResourceOnServer("tgiann-hotwire") then
