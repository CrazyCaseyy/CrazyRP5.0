...
Config = {
    ...
    BallElasticity = 1.2,
    Tutorial = {
        {text = 'Tennis will start when two players join, one on each side.', time = 5000},
        {text = 'To serve, enter the checkpoint, press E to start serving.', time = 5000},
        {text = 'When serving, move to a position from which you want to serve and press Left Mouse Button', time = 5000},
        {text = 'Select power with which you want to serve and use WSAD to aim where you want to shoot.', time = 5000},
        {text = 'When serving, always aim to the diagonal corner, so use either A or AW keys.', time = 5000},
        {text = "Before returning, it's easiest to wait until the ball first bounces off the ground.", time = 5000},
        {text = "Bottom spin will carry the ball further, top spin will carry the ball less.", time = 5000},
    },
    Translation = {
        SECOND_SERVE = 'Second Serve',
        OPPONENT_WON_POINT = 'Opponent won point!',
        YOU_WON_POINT = 'You won point!',
        OPPONENT_WON_GAME = 'Opponent won game!',
        YOU_WON_GAME = 'You won game!',
        ...
        SERVE_HINT = 'To correctly serve, aim with key  to hit highlighted rectangle.~n~Ball must hit ground first before opponent can return.~n~LEFT CLICK to initiate serve.',
