...
Config.Main = { -- Main variables
	...
	JobRoles = { 				-- These are the job roles who can use items if RequiresJob is enabled.
		"hayes", "bennys", "redline", "lscustoms", "eastcustoms", "importshop", "tunershop", "beekers", "exotic", "ottos", "dreamworks","mirrorparkmech","standcustoms"
	},
	...
	Stash = {
		...
		sharedStash = true, 		-- Enable if mechanic with same job name share stash
...
Config.Overrides = {
	...
	crashFX = false,					-- if true, when crashing theres a chance based on damage done for the camera to have extra screenshake
