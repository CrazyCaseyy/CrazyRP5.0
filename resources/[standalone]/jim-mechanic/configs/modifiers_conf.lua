...
Config.PlateChange = {
    UseItem = false,                 -- Can the users change plates with an item
...
Config.Harness = {
    HarnessControl = true,			-- Enable harness AND seatbelt features of the script, requires edits to smallresources and hud scripts
                                    -- Disable to
    JobOnly = false,					-- Only allow job roles to add a Harness to vehicle, otherwise any one can add them
    ...
    seatbeltEasyLeave = false,		-- if true players can exit vehicle before removing SEATBELT
    harnessEasyLeave = false,		-- if true players can exit vehicles before removing HARNESS
    ...
    minimumSpeed = 40.0,			-- Minimum speed for crash logic to be triggered - Default: 20.0 (50 mph)
    minimumSeatBeltSpeed = 320.0, 	-- Minimuim speed for ejecting with a seatbelt attached Default: 160.0 (100 mph)
    ...
    harnessSpeed = 210.0,            -- Minimum speed to eject with harness on Default: 200.0 (150 mph)
...
Config.vehFailure = {
    ...
    extraDamage = {
        ...
        engineDamageMultiplier = 0.2,                   -- Multiplier for engine damage based on crash damage
        bodyDamageMultiplier = 0.1,                     -- Multiplier for body damage based on crash damage
    },
...
Config.NOS = {
    ...
    useExternalHud = true,     -- If this is true it will use a helper function to show nos on other huds
...
Config.Stancer = {
    enable = false,				-- Enable or disable Stancerkits
