...
Locations["altastreet_gabz"] = {
	...
	Shop = {
		{   coords = vec4(-241.9, -1338.08, 30.9, 93.39), width = 3.6, depth = 0.8,
            label = "Shop", icon = "fas fa-box-open",
        },
	},
	Crafting = {
		{	coords = vec4(-240.14, -1314.11, 30.9, 359.11), width = 2.8, depth = 1.5,
    ...
    BossMenus = {
        {   coords = vec4(-198.62, -1340.73, 34.9, 14.77), width = 0.6, depth = 0.6,
            label = "Open Bossmenu", icon = "fas fa-list",
        },
    },
    BossStash = {
		{   prop = { model = "sf_prop_v_43_safe_s_bk_01a", coords = vec4(-202.37, -1337.46, 34.9, 278.26) },
	...
	manualRepair = {
		{ 	prop = { model = "xm3_prop_xm3_tool_draw_01d", coords = vec4(-200.38, -1309.62, 31.29, 2.88), },
			label = "Manual Repair", icon = "fas fa-cogs",
		},
	},
	Payments = {
		{ 	prop = { model = "prop_till_01", coords = vec4(-200.54, -1314.54, 32.08, 189.22), },
