...
Locations["redline_rfx"] = {
    ...
    Stash = {
        {   coords = vec4(-589.33, -930.19, 28.14, 90.0), width = 2.25, depth = 5.6,
            label = "Mech Stash", icon = "fas fa-cogs",
            slots = 50, maxWeight = 4000000,
        },
        {   coords = vec4(-570.32, -911.28, 23.89, 180.0), width = 0.85, depth = 3.8,
            label = "Mech Stash", icon = "fas fa-cogs",
            slots = 50, maxWeight = 4000000,
        },
        {   coords = vec4(-568.6, -939.66, 23.89, 180.0), width = 0.85, depth = 3.8,
            label = "Mech Stash", icon = "fas fa-cogs",
            slots = 50, maxWeight = 4000000,
        },
    },
    PersonalStash = {
        {   coords = vec4(-601.78, -913.26, 23.89, 180.0), width = 0.6, depth = 3.8,
    ...
    Shop = {
        {   coords = vec4(-589.26, -938.59, 28.14, 90.0), width = 2.25, depth = 2.8,
            label = "Shop", icon = "fas fa-box-open",
        },
    },
    Crafting = {
        {   coords = vec4(-587.21, -932.48, 23.89, 270.0), width = 0.65, depth = 3.8,
            label = "Mechanic Crafting", icon = "fas fa-screwdriver-wrench",
        },
        {   coords = vec4(-587.35, -923.86, 24.05, 270.0), width = 0.65, depth = 3.8,
            label = "Mechanic Crafting", icon = "fas fa-screwdriver-wrench",
        },
        {   coords = vec4(-587.24, -918.46, 23.89, 270.0), width = 0.65, depth = 3.8,
            label = "Mechanic Crafting", icon = "fas fa-screwdriver-wrench",
        },
        {   coords = vec4(-584.09, -913.17, 23.89, 180.0), width = 0.85, depth = 3.8,
            label = "Mechanic Crafting", icon = "fas fa-screwdriver-wrench",
        },
    },
    Clockin = { },
    BossMenus = {
        {   coords = vec4(-604.53, -919.5, 23.89, 90.0), width = 0.6, depth = 0.8,
            label = "Open Bossmenu", icon = "fas fa-list",
        },
    },
    BossStash = {
        {   coords = vec4(-604.41, -922.86, 23.89, 0.0), width = 0.65, depth = 3.8,
