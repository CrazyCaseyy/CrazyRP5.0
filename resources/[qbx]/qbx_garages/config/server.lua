    ...
    garages = {
        ...
        policefleet = {
            ...
            accessPoints = {
                ...
                {
                    coords = vec4(408.56, -997.61, 20.45, 266.45),
                    spawn = vec4(408.56, -997.61, 20.45, 266.45),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(409.06, -994.46, 20.45, 264.73),
                    spawn = vec4(409.06, -994.46, 20.45, 264.73),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(411.63, -991.43, 19.84, 270.52),
                    spawn = vec4(411.63, -991.43, 19.84, 270.52),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(409.53, -988.48, 19.84, 270.53),
                    spawn = vec4(409.53, -988.48, 19.84, 270.53),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(410.51, -985.4, 19.84, 269.51),
                    spawn = vec4(410.51, -985.4, 19.84, 269.51),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(409.72, -963.98, 19.84, 270.36),
                    spawn = vec4(409.72, -963.98, 19.84, 270.36),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(410.13, -961.0, 19.84, 270.19),
                    spawn = vec4(410.13, -961.0, 19.84, 270.19),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(411.76, -957.97, 19.84, 270.52),
                    spawn = vec4(411.76, -957.97, 19.84, 270.52),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(410.63, -955.02, 19.84, 270.56),
                    spawn = vec4(410.63, -955.02, 19.84, 270.56),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(410.37, -951.94, 19.84, 271.6),
                    spawn = vec4(410.37, -951.94, 19.84, 271.6),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(421.94, -988.47, 19.84, 89.64),
                    spawn = vec4(421.94, -988.47, 19.84, 89.64),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(422.09, -985.41, 19.84, 89.5),
                    spawn = vec4(422.09, -985.41, 19.84, 89.5),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(421.94, -980.66, 19.84, 88.52),
                    spawn = vec4(421.94, -980.66, 19.84, 88.52),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(422.01, -977.71, 19.84, 90.18),
                    spawn = vec4(422.01, -977.71, 19.84, 90.18),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(422.12, -971.77, 19.84, 89.03),
                    spawn = vec4(422.12, -971.77, 19.84, 89.03),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(421.65, -968.64, 19.84, 90.06),
                    spawn = vec4(421.65, -968.64, 19.84, 90.06),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(421.83, -964.01, 19.84, 89.21),
                    spawn = vec4(421.83, -964.01, 19.84, 89.21),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(422.0, -960.98, 19.84, 90.03),
                    spawn = vec4(422.0, -960.98, 19.84, 90.03),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(427.03, -960.95, 19.84, 268.54),
                    spawn = vec4(427.03, -960.95, 19.84, 268.54),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(427.53, -964.03, 19.84, 270.97),
                    spawn = vec4(427.53, -964.03, 19.84, 270.97),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(427.18, -968.7, 19.84, 270.46),
                    spawn = vec4(427.18, -968.7, 19.84, 270.46),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(427.06, -971.76, 19.84, 270.15),
                    spawn = vec4(427.06, -971.76, 19.84, 270.15),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(427.06, -977.71, 19.84, 268.19),
                    spawn = vec4(427.06, -977.71, 19.84, 268.19),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(427.2, -980.77, 19.84, 269.77),
                    spawn = vec4(427.2, -980.77, 19.84, 269.77),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(427.18, -985.39, 19.84, 268.07),
                    spawn = vec4(427.18, -985.39, 19.84, 268.07),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(427.15, -988.41, 19.84, 268.24),
                    spawn = vec4(427.15, -988.41, 19.84, 268.24),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(438.91, -988.5, 19.84, 89.25),
                    spawn = vec4(438.91, -988.5, 19.84, 89.25),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(438.57, -985.37, 19.84, 89.66),
                    spawn = vec4(438.57, -985.37, 19.84, 89.66),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(438.65, -980.7, 19.84, 89.19),
                    spawn = vec4(438.65, -980.7, 19.84, 89.19),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(438.77, -977.68, 19.84, 89.12),
                    spawn = vec4(438.77, -977.68, 19.84, 89.12),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(438.66, -971.72, 19.84, 90.67),
                    spawn = vec4(438.66, -971.72, 19.84, 90.67),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(438.54, -968.61, 19.84, 89.19),
                    spawn = vec4(438.54, -968.61, 19.84, 89.19),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(438.71, -963.99, 19.84, 89.57),
                    spawn = vec4(438.71, -963.99, 19.84, 89.57),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(438.84, -960.99, 19.84, 88.93),
                    spawn = vec4(438.84, -960.99, 19.84, 88.93),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(443.72, -961.01, 19.84, 269.36),
                    spawn = vec4(443.72, -961.01, 19.84, 269.36),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(443.91, -964.03, 19.84, 269.48),
                    spawn = vec4(443.91, -964.03, 19.84, 269.48),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(443.83, -968.68, 19.84, 269.69),
                    spawn = vec4(443.83, -968.68, 19.84, 269.69),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(443.84, -971.78, 19.84, 269.24),
                    spawn = vec4(443.84, -971.78, 19.84, 269.24),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(443.91, -977.75, 19.84, 269.14),
                    spawn = vec4(443.91, -977.75, 19.84, 269.14),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(443.8, -980.73, 19.84, 268.91),
                    spawn = vec4(443.8, -980.73, 19.84, 268.91),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
                {
                    coords = vec4(443.79, -985.46, 19.84, 270.25),
                    spawn = vec4(443.79, -985.46, 19.84, 270.25),
                    useRadius = 3.0,
                    dropUseRadius = 3.0,
                },
            },
