return {
    {
        ...
        entitySets = {
            {name = "villa_s_props_yes", enable = true},
            {name = "villa_s_props_no", enable = false}
        }
    },
    {
    ...
    },
    {
        ...
        entitySets = {
            {name = "villa_l_props_yes", enable = true},
            {name = "villa_s_props_no", enable = false}
        }
    },
    {
    ...
    },
    {
        ...
        entitySets = {
            {name = "casino_table_slots_wheel_yes", enable = true},
            {name = "enable_3d_logos", enable = true},
        }
    },
}
